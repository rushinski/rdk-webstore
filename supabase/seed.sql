...
seed_products as (
  select * from (values
    ...
    ('SEED-BALE-TRIPLE-S', 'Balenciaga Triple S', 'Triple S', 'Balenciaga', 'Triple S', 'sneakers', 'new', true, true, 98000, 'shoe', '9', 2, 60000, 'Chunky triple-layered sole.', '/images/rdk-logo.png', 0.9),
    ('SEED-BALE-RUNNER', 'Balenciaga Runner', 'Runner', 'Balenciaga', 'Runner', 'sneakers', 'new', true, true, 94000, 'shoe', '10', 2, 58000, 'Distressed runner silhouette.', '/images/rdk-logo.png', 0.9),
    ('SEED-BALE-TRACK', 'Balenciaga Track', 'Track', 'Balenciaga', 'Track', 'sneakers', 'new', true, true, 92000, 'shoe', '9.5', 2, 56000, 'Multi-layered track sneaker.', '/images/rdk-logo.png', 0.9),
    ...
    ('SEED-VALE-TEE', 'Vale Logo Tee', 'Logo Tee', 'Vale', null, 'clothing', 'new', true, true, 4500, 'clothing', 'L', 10, 2000, 'Soft cotton graphic tee.', '/images/rdk-logo.png', 0.9),
    ...
    ('SEED-BALE-TEE', 'Balenciaga Logo Tee', 'Logo Tee', 'Balenciaga', null, 'clothing', 'new', true, true, 42000, 'clothing', 'M', 5, 24000, 'Relaxed-fit logo tee.', '/images/rdk-logo.png', 0.9),
    ('SEED-BAPE-HOODIE', 'Bape Shark Hoodie', 'Shark Hoodie', 'Bape', null, 'clothing', 'new', true, true, 32000, 'clothing', 'L', 4, 18000, 'Full-zip shark hoodie.', '/images/rdk-logo.png', 0.9),
    ('SEED-DENIM-TEARS-JACKET', 'Denim Tears Cotton Wreath Jacket', 'Cotton Wreath Jacket', 'Denim Tears', null, 'clothing', 'new', true, true, 38000, 'clothing', 'L', 3, 22000, 'Signature cotton wreath print.', '/images/rdk-logo.png', 0.9),
...
seed_products as (
  select * from (values
    ...
    ('SEED-BALE-TRIPLE-S', 'shoe', '9', 98000, 2, 60000),
    ('SEED-BALE-RUNNER', 'shoe', '10', 94000, 2, 58000),
    ('SEED-BALE-TRACK', 'shoe', '9.5', 92000, 2, 56000),
    ...
    ('SEED-VALE-TEE', 'clothing', 'L', 4500, 10, 2000),
    ('SEED-GODSPEED-JACKET', 'clothing', 'L', 12000, 4, 7000),
    ('SEED-BALE-TEE', 'clothing', 'M', 42000, 5, 24000),
    ('SEED-BAPE-HOODIE', 'clothing', 'L', 32000, 4, 18000),
    ('SEED-DENIM-TEARS-JACKET', 'clothing', 'L', 38000, 3, 22000),
...
seed_products as (
  select * from (values
    ...
    ('SEED-BALE-TRIPLE-S', '/images/rdk-logo.png'),
    ('SEED-BALE-RUNNER', '/images/rdk-logo.png'),
    ('SEED-BALE-TRACK', '/images/rdk-logo.png'),
    ...
    ('SEED-VALE-TEE', '/images/rdk-logo.png'),
    ('SEED-GODSPEED-JACKET', '/images/rdk-logo.png'),
    ('SEED-BALE-TEE', '/images/rdk-logo.png'),
    ('SEED-BAPE-HOODIE', '/images/rdk-logo.png'),
    ('SEED-DENIM-TEARS-JACKET', '/images/rdk-logo.png'),
