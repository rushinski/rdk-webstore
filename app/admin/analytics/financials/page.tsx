...
export default function AnalyticsFinancialsPage() {
  ...
  const salesTrend = useMemo(
    () => normalizeDailySeries(range, salesTrendRaw, "revenue"),
    [range, salesTrendRaw],
  );
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Revenue, profit, and order performance for the selected reporting window."
        actions={
          <RdkSelect
            value={range}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="relative">
          <div className="absolute right-4 top-4">
            <ShoppingCart className="h-5 w-5 text-brand-muted" />
          </div>
          <AdminMetricCard
            label="Orders"
      ...
      <AdminSectionCard title="Trend">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-brand-text">Revenue Trend</h2>
