...
describe("create label form structure", () => {
  it("delegates rate lookup and label purchase workflows to a focused hook", () => {
    ...
    expect(source).toContain(
      "@/modules/orders/presentation/admin/shipping/useCreateLabelFormMutations",
    );
  ...
  it("delegates create-label helper and display logic to a focused module", () => {
    ...
    expect(source).toContain(
      "@/modules/orders/presentation/admin/shipping/createLabelFormView",
    );
  ...
  it("delegates create-label form state and input handlers to a focused hook", () => {
    ...
    expect(source).toContain(
      "@/modules/orders/presentation/admin/shipping/useCreateLabelFormState",
    );
  ...
  it("delegates the recipient editor and rates panel to focused components", () => {
    ...
    expect(source).toContain(
      "@/modules/orders/presentation/admin/shipping/CreateLabelRecipientPanel",
    );
    expect(source).toContain(
      "@/modules/orders/presentation/admin/shipping/CreateLabelRatesPanel",
    );
