...
describe("admin catalog module migration structure", () => {
  it("makes the catalog screen shell and orchestration hooks module-owned", () => {
    const modulePaths = [
      ...
      "src/modules/catalog/presentation/admin/catalog/catalogMutationRequests.ts",
      "src/modules/catalog/presentation/admin/catalog/catalogMutationValidation.ts",
      ...
      "src/modules/catalog/presentation/admin/catalog/components/ConfirmDisableTagModal.tsx",
      "src/modules/catalog/presentation/admin/catalog/components/CatalogToolbar.tsx",
      "src/modules/catalog/presentation/admin/catalog/components/CreateTagModals.tsx",
      "src/modules/catalog/presentation/admin/catalog/components/EditTagModal.tsx",
      "src/modules/catalog/presentation/admin/catalog/components/TagModals.tsx",
      "src/modules/catalog/presentation/admin/catalog/components/TagModalShell.tsx",
  ...
  it("keeps the legacy catalog shell and orchestration hooks as thin shims", () => {
    const legacyPaths = [
      ...
      "src/components/admin/catalog/catalogDataRequests.ts",
      "src/components/admin/catalog/catalogEditState.ts",
      "src/components/admin/catalog/catalogMutationRequests.ts",
      "src/components/admin/catalog/catalogMutationValidation.ts",
      ...
      "src/components/admin/catalog/components/ConfirmDisableTagModal.tsx",
      "src/components/admin/catalog/components/CatalogToolbar.tsx",
      "src/components/admin/catalog/components/CreateTagModals.tsx",
      "src/components/admin/catalog/components/EditTagModal.tsx",
      "src/components/admin/catalog/components/TagModals.tsx",
      "src/components/admin/catalog/components/TagModalShell.tsx",
