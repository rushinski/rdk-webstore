  ...
  public: {
    Tables: {
      ...
      inventory_external_variants: {
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_external_variants_last_import_id_fkey"
          ...
          {
            foreignKeyName: "inventory_external_variants_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "inventory_external_variants_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inventory_external_variants_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
      ...
      inventory_import_rows: {
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_import_rows_import_id_fkey"
            columns: ["import_id"]
            isOneToOne: false
            referencedRelation: "inventory_imports"
            referencedColumns: ["id"]
      ...
      inventory_imports: {
        ...
        Relationships: [
          {
            foreignKeyName: "inventory_imports_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inventory_imports_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
