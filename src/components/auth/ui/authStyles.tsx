...
export const AuthStyles = {
  ...
  accentLink:
    "text-sm font-medium text-red-600 hover:text-red-500 transition-colors",

  inlineAccentLink:
    "font-medium text-red-600 hover:text-red-500 transition-colors",

  errorBox:
    "border border-red-900 bg-red-950/30 px-4 py-3 text-sm text-red-400",
