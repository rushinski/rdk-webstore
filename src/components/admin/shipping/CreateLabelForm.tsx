...
import { CreateLabelRatesPanel } from "@/components/admin/shipping/CreateLabelRatesPanel";
import { CreateLabelRecipientPanel } from "@/components/admin/shipping/CreateLabelRecipientPanel";
import type {
  OrderSummary,
  ParcelDraft,
