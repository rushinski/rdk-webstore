...
import { buildPickupOrderItemModel } from "@/components/admin/pickups/pickupOrdersTableView";
...
type PickupExpandedItemsRowProps = Pick<
  PickupOrderExpansionPanelsProps,
  "colSpan" | "getOrderTitle" | "getPrimaryImage" | "onOpenItemDetails" | "order"
>;

export function PickupExpandedItemsRow({
  colSpan,
  getOrderTitle,
  getPrimaryImage,
  onOpenItemDetails,
  order,
}: PickupExpandedItemsRowProps) {
  return (
