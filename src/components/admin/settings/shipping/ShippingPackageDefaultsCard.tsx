import type { ShippingDefaultValues } from "@/components/admin/settings/shipping/shippingSettingsConfig";
import { SHIPPING_CATEGORIES } from "@/components/admin/settings/shipping/shippingSettingsConfig";
